 ...
 */
public class SignatureTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.xmldsig.SignatureType
{
     ...
     */
    public org.kopi.ebics.schema.xmldsig.SignatureValueType getSignatureValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.xmldsig.SignatureValueType target = null;
            target = (org.kopi.ebics.schema.xmldsig.SignatureValueType)get_store().find_element_user(SIGNATUREVALUE$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSignatureValue(org.kopi.ebics.schema.xmldsig.SignatureValueType signatureValue)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.xmldsig.SignatureValueType)get_store().add_element_user(SIGNATUREVALUE$2);
            }
     ...
     */
    public org.kopi.ebics.schema.xmldsig.SignatureValueType addNewSignatureValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public org.kopi.ebics.schema.xmldsig.KeyInfoType getKeyInfo()
    {
        synchronized (monitor())
        {
            ...
            target = (org.kopi.ebics.schema.xmldsig.KeyInfoType)get_store().find_element_user(KEYINFO$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setKeyInfo(org.kopi.ebics.schema.xmldsig.KeyInfoType keyInfo)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.xmldsig.KeyInfoType)get_store().add_element_user(KEYINFO$4);
            }
            target.set(keyInfo);
        }
    }
     ...
     */
    public org.kopi.ebics.schema.xmldsig.ObjectType[] getObjectArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            org.kopi.ebics.schema.xmldsig.ObjectType[] result = new org.kopi.ebics.schema.xmldsig.ObjectType[targetList.size()];
     ...
     */
    public org.kopi.ebics.schema.xmldsig.ObjectType getObjectArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.xmldsig.ObjectType target = null;
            target = (org.kopi.ebics.schema.xmldsig.ObjectType)get_store().find_element_user(OBJECT$6, i);
            if (target == null)
            {
     ...
     */
    public void setObjectArray(org.kopi.ebics.schema.xmldsig.ObjectType[] objectArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setObjectArray(int i, org.kopi.ebics.schema.xmldsig.ObjectType object)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.kopi.ebics.schema.xmldsig.ObjectType insertNewObject(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.xmldsig.ObjectType target = null;
            target = (org.kopi.ebics.schema.xmldsig.ObjectType)get_store().insert_element_user(OBJECT$6, i);
            return target;
        }
    }
    ...
    public org.kopi.ebics.schema.xmldsig.ObjectType addNewObject()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.xmldsig.ObjectType target = null;
            target = (org.kopi.ebics.schema.xmldsig.ObjectType)get_store().add_element_user(OBJECT$6);
            return target;
        }
    }
