 ...
 */
public class SignatureMethodTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.xmldsig.SignatureMethodType
{
     ...
     */
    public org.kopi.ebics.schema.xmldsig.HMACOutputLengthType xgetHMACOutputLength()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.xmldsig.HMACOutputLengthType target = null;
            target = (org.kopi.ebics.schema.xmldsig.HMACOutputLengthType)get_store().find_element_user(HMACOUTPUTLENGTH$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetHMACOutputLength(org.kopi.ebics.schema.xmldsig.HMACOutputLengthType hmacOutputLength)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.xmldsig.HMACOutputLengthType)get_store().add_element_user(HMACOUTPUTLENGTH$0);
            }
