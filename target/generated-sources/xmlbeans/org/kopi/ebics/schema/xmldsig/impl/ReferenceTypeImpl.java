 ...
 */
public class ReferenceTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.xmldsig.ReferenceType
{
    ...
    public org.kopi.ebics.schema.xmldsig.DigestMethodType getDigestMethod()
    {
        synchronized (monitor())
        {
            ...
            target = (org.kopi.ebics.schema.xmldsig.DigestMethodType)get_store().find_element_user(DIGESTMETHOD$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setDigestMethod(org.kopi.ebics.schema.xmldsig.DigestMethodType digestMethod)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.xmldsig.DigestMethodType)get_store().add_element_user(DIGESTMETHOD$2);
            }
    ...
    public org.kopi.ebics.schema.xmldsig.DigestValueType xgetDigestValue()
    {
        synchronized (monitor())
        {
            ...
            target = (org.kopi.ebics.schema.xmldsig.DigestValueType)get_store().find_element_user(DIGESTVALUE$4, 0);
            return target;
        }
    }
    ...
    public void xsetDigestValue(org.kopi.ebics.schema.xmldsig.DigestValueType digestValue)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.xmldsig.DigestValueType)get_store().add_element_user(DIGESTVALUE$4);
            }
