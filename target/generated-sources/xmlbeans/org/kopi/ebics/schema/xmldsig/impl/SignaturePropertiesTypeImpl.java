 ...
 */
public class SignaturePropertiesTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.xmldsig.SignaturePropertiesType
{
     ...
     */
    public org.kopi.ebics.schema.xmldsig.SignaturePropertyType[] getSignaturePropertyArray()
    {
        synchronized (monitor())
        {
            ...
            org.kopi.ebics.schema.xmldsig.SignaturePropertyType[] result = new org.kopi.ebics.schema.xmldsig.SignaturePropertyType[targetList.size()];
     ...
     */
    public org.kopi.ebics.schema.xmldsig.SignaturePropertyType getSignaturePropertyArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.xmldsig.SignaturePropertyType target = null;
            target = (org.kopi.ebics.schema.xmldsig.SignaturePropertyType)get_store().find_element_user(SIGNATUREPROPERTY$0, i);
            if (target == null)
            {
     ...
     */
    public void setSignaturePropertyArray(org.kopi.ebics.schema.xmldsig.SignaturePropertyType[] signaturePropertyArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setSignaturePropertyArray(int i, org.kopi.ebics.schema.xmldsig.SignaturePropertyType signatureProperty)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.kopi.ebics.schema.xmldsig.SignaturePropertyType insertNewSignatureProperty(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.xmldsig.SignaturePropertyType target = null;
            target = (org.kopi.ebics.schema.xmldsig.SignaturePropertyType)get_store().insert_element_user(SIGNATUREPROPERTY$0, i);
            return target;
        }
    }
