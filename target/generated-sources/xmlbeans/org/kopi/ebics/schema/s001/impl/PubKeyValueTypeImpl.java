 ...
 */
public class PubKeyValueTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.s001.PubKeyValueType
{
     ...
     */
    public org.kopi.ebics.schema.s001.TimestampType xgetTimeStamp()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.s001.TimestampType target = null;
            target = (org.kopi.ebics.schema.s001.TimestampType)get_store().find_element_user(TIMESTAMP$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetTimeStamp(org.kopi.ebics.schema.s001.TimestampType timeStamp)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.s001.TimestampType)get_store().add_element_user(TIMESTAMP$2);
            }
