 ...
 */
public class OrderSignatureDataTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.s001.OrderSignatureDataType
{
    ...
    public org.kopi.ebics.schema.s001.PartnerIDType xgetPartnerID()
    {
        synchronized (monitor())
        {
            ...
            target = (org.kopi.ebics.schema.s001.PartnerIDType)get_store().find_element_user(PARTNERID$4, 0);
            return target;
        }
    }
    ...
    public void xsetPartnerID(org.kopi.ebics.schema.s001.PartnerIDType partnerID)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.s001.PartnerIDType)get_store().add_element_user(PARTNERID$4);
            }
    ...
    public org.kopi.ebics.schema.s001.UserIDType xgetUserID()
    {
        synchronized (monitor())
        {
            ...
            target = (org.kopi.ebics.schema.s001.UserIDType)get_store().find_element_user(USERID$6, 0);
            return target;
        }
    }
    ...
    public void xsetUserID(org.kopi.ebics.schema.s001.UserIDType userID)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.s001.UserIDType)get_store().add_element_user(USERID$6);
            }
            target.set(userID);
        }
    }
    ...
    public org.kopi.ebics.schema.xmldsig.X509DataType getX509Data()
    {
        synchronized (monitor())
        {
            ...
            target = (org.kopi.ebics.schema.xmldsig.X509DataType)get_store().find_element_user(X509DATA$8, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setX509Data(org.kopi.ebics.schema.xmldsig.X509DataType x509Data)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.xmldsig.X509DataType)get_store().add_element_user(X509DATA$8);
            }
            target.set(x509Data);
        }
    }
