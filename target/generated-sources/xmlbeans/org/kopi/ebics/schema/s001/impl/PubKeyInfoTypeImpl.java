 ...
 */
public class PubKeyInfoTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.s001.PubKeyInfoType
{
     ...
     */
    public org.kopi.ebics.schema.s001.PubKeyValueType getPubKeyValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.s001.PubKeyValueType target = null;
            target = (org.kopi.ebics.schema.s001.PubKeyValueType)get_store().find_element_user(PUBKEYVALUE$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPubKeyValue(org.kopi.ebics.schema.s001.PubKeyValueType pubKeyValue)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.s001.PubKeyValueType)get_store().add_element_user(PUBKEYVALUE$2);
            }
     ...
     */
    public org.kopi.ebics.schema.s001.PubKeyValueType addNewPubKeyValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
