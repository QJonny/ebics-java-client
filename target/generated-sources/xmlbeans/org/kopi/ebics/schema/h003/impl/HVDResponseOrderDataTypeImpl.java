 ...
 */
public class HVDResponseOrderDataTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.h003.HVDResponseOrderDataType
{
    ...
    public org.kopi.ebics.schema.h003.DataDigestType getDataDigest()
    {
        synchronized (monitor())
        {
            ...
            target = (org.kopi.ebics.schema.h003.DataDigestType)get_store().find_element_user(DATADIGEST$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public org.kopi.ebics.schema.h003.SignerInfoType getSignerInfoArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (org.kopi.ebics.schema.h003.SignerInfoType)get_store().find_element_user(SIGNERINFO$10, i);
            if (target == null)
            {
    ...
    public org.kopi.ebics.schema.h003.SignerInfoType insertNewSignerInfo(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.h003.SignerInfoType target = null;
            target = (org.kopi.ebics.schema.h003.SignerInfoType)get_store().insert_element_user(SIGNERINFO$10, i);
            return target;
        }
    }
    ...
    public org.kopi.ebics.schema.h003.SignerInfoType addNewSignerInfo()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.h003.SignerInfoType target = null;
            target = (org.kopi.ebics.schema.h003.SignerInfoType)get_store().add_element_user(SIGNERINFO$10);
            return target;
        }
    }
