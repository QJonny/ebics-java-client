 ...
 */
public class ParameterDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.h003.ParameterDocument
{
     ...
     */
    public org.kopi.ebics.schema.h003.ParameterDocument.Parameter getParameter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.h003.ParameterDocument.Parameter target = null;
            target = (org.kopi.ebics.schema.h003.ParameterDocument.Parameter)get_store().find_element_user(PARAMETER$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setParameter(org.kopi.ebics.schema.h003.ParameterDocument.Parameter parameter)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ParameterImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.h003.ParameterDocument.Parameter
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public org.kopi.ebics.schema.h003.ParameterDocument.Parameter.Value getValue()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.kopi.ebics.schema.h003.ParameterDocument.Parameter.Value target = null;
                target = (org.kopi.ebics.schema.h003.ParameterDocument.Parameter.Value)get_store().find_element_user(VALUE$2, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public void setValue(org.kopi.ebics.schema.h003.ParameterDocument.Parameter.Value value)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.kopi.ebics.schema.h003.ParameterDocument.Parameter.Value)get_store().add_element_user(VALUE$2);
                }
                target.set(value);
            }
        }
         ...
         */
        public org.kopi.ebics.schema.h003.ParameterDocument.Parameter.Value addNewValue()
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public static class ValueImpl extends org.apache.xmlbeans.impl.values.XmlAnySimpleTypeImpl implements org.kopi.ebics.schema.h003.ParameterDocument.Parameter.Value
        {
            private static final long serialVersionUID = 1L;
