 ...
 */
public class HPDProtocolParamsTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.h003.HPDProtocolParamsType
{
     ...
     */
    public org.kopi.ebics.schema.h003.HPDVersionType getVersion()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.h003.HPDVersionType target = null;
            target = (org.kopi.ebics.schema.h003.HPDVersionType)get_store().find_element_user(VERSION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setVersion(org.kopi.ebics.schema.h003.HPDVersionType version)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.h003.HPDVersionType)get_store().add_element_user(VERSION$0);
            }
            target.set(version);
        }
    }
     ...
     */
    public org.kopi.ebics.schema.h003.HPDVersionType addNewVersion()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.kopi.ebics.schema.h003.HPDProtocolParamsType.Recovery getRecovery()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.h003.HPDProtocolParamsType.Recovery target = null;
            target = (org.kopi.ebics.schema.h003.HPDProtocolParamsType.Recovery)get_store().find_element_user(RECOVERY$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRecovery(org.kopi.ebics.schema.h003.HPDProtocolParamsType.Recovery recovery)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.h003.HPDProtocolParamsType.Recovery)get_store().add_element_user(RECOVERY$2);
            }
            target.set(recovery);
        }
    }
     ...
     */
    public org.kopi.ebics.schema.h003.HPDProtocolParamsType.Recovery addNewRecovery()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.kopi.ebics.schema.h003.HPDProtocolParamsType.PreValidation getPreValidation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.h003.HPDProtocolParamsType.PreValidation target = null;
            target = (org.kopi.ebics.schema.h003.HPDProtocolParamsType.PreValidation)get_store().find_element_user(PREVALIDATION$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPreValidation(org.kopi.ebics.schema.h003.HPDProtocolParamsType.PreValidation preValidation)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.h003.HPDProtocolParamsType.PreValidation)get_store().add_element_user(PREVALIDATION$4);
            }
     ...
     */
    public org.kopi.ebics.schema.h003.HPDProtocolParamsType.PreValidation addNewPreValidation()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.kopi.ebics.schema.h003.HPDProtocolParamsType.X509Data getX509Data()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.h003.HPDProtocolParamsType.X509Data target = null;
            target = (org.kopi.ebics.schema.h003.HPDProtocolParamsType.X509Data)get_store().find_element_user(X509DATA$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setX509Data(org.kopi.ebics.schema.h003.HPDProtocolParamsType.X509Data x509Data)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.h003.HPDProtocolParamsType.X509Data)get_store().add_element_user(X509DATA$6);
            }
            target.set(x509Data);
        }
    }
     ...
     */
    public org.kopi.ebics.schema.h003.HPDProtocolParamsType.X509Data addNewX509Data()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.kopi.ebics.schema.h003.HPDProtocolParamsType.ClientDataDownload getClientDataDownload()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.h003.HPDProtocolParamsType.ClientDataDownload target = null;
            target = (org.kopi.ebics.schema.h003.HPDProtocolParamsType.ClientDataDownload)get_store().find_element_user(CLIENTDATADOWNLOAD$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setClientDataDownload(org.kopi.ebics.schema.h003.HPDProtocolParamsType.ClientDataDownload clientDataDownload)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.h003.HPDProtocolParamsType.ClientDataDownload)get_store().add_element_user(CLIENTDATADOWNLOAD$8);
            }
     ...
     */
    public org.kopi.ebics.schema.h003.HPDProtocolParamsType.ClientDataDownload addNewClientDataDownload()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.kopi.ebics.schema.h003.HPDProtocolParamsType.DownloadableOrderData getDownloadableOrderData()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.kopi.ebics.schema.h003.HPDProtocolParamsType.DownloadableOrderData target = null;
            target = (org.kopi.ebics.schema.h003.HPDProtocolParamsType.DownloadableOrderData)get_store().find_element_user(DOWNLOADABLEORDERDATA$10, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDownloadableOrderData(org.kopi.ebics.schema.h003.HPDProtocolParamsType.DownloadableOrderData downloadableOrderData)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.kopi.ebics.schema.h003.HPDProtocolParamsType.DownloadableOrderData)get_store().add_element_user(DOWNLOADABLEORDERDATA$10);
            }
     ...
     */
    public org.kopi.ebics.schema.h003.HPDProtocolParamsType.DownloadableOrderData addNewDownloadableOrderData()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class RecoveryImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.h003.HPDProtocolParamsType.Recovery
    {
        private static final long serialVersionUID = 1L;
     ...
     * This is a complex type.
     */
    public static class PreValidationImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.h003.HPDProtocolParamsType.PreValidation
    {
        private static final long serialVersionUID = 1L;
     ...
     * This is a complex type.
     */
    public static class X509DataImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.h003.HPDProtocolParamsType.X509Data
    {
        private static final long serialVersionUID = 1L;
     ...
     * This is a complex type.
     */
    public static class ClientDataDownloadImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.h003.HPDProtocolParamsType.ClientDataDownload
    {
        private static final long serialVersionUID = 1L;
     ...
     * This is a complex type.
     */
    public static class DownloadableOrderDataImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.kopi.ebics.schema.h003.HPDProtocolParamsType.DownloadableOrderData
    {
        private static final long serialVersionUID = 1L;
